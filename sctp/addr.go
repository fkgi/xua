...
// ResolveSCTPAddr parses addr as a SCTP address of the form "host:port" or "[ipv6-host%zone]:port"
// and resolves a pair of domain name and port name on the network net,
